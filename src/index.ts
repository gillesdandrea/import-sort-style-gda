...
export default function(styleApi: IStyleAPI): Array<IStyleItem> {
  ...
  return [
    ...
    {match: and(hasDefaultMember, isAbsoluteModule, not(member(startsWithAlphanumeric))), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    ...
    {match: and(hasDefaultMember, isAbsoluteModule, member(startsWithUpperCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    ...
    {match: and(hasDefaultMember, isAbsoluteModule, member(startsWithLowerCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    
    {separator: true},
    
    // import * as _ from "bar";
    {match: and(hasOnlyNamespaceMember, isAbsoluteModule, not(member(startsWithAlphanumeric))), sort: moduleName(unicode)},
    ...
    // import {_, bar, …} from "baz";
    {match: and(hasOnlyNamedMembers, isAbsoluteModule, not(member(startsWithAlphanumeric))), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    // import {Foo, bar, …} from "baz";
    {match: and(hasOnlyNamedMembers, isAbsoluteModule, member(startsWithUpperCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    // import {foo, bar, …} from "baz";
    {match: and(hasOnlyNamedMembers, isAbsoluteModule, member(startsWithLowerCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    ...
    {match: and(hasDefaultMember, isRelativeModule, not(member(startsWithAlphanumeric))), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    ...
    {match: and(hasDefaultMember, isRelativeModule, member(startsWithUpperCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    ...
    {match: and(hasDefaultMember, isRelativeModule, member(startsWithLowerCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    
    {separator: true},

    // import * as _ from "./bar";
    {match: and(hasOnlyNamespaceMember, isRelativeModule, not(member(startsWithAlphanumeric))), sort: moduleName(unicode)},
    // import * as Foo from "./bar";
    ...
    // import {_, bar, …} from "./baz";
    {match: and(hasOnlyNamedMembers, isRelativeModule, not(member(startsWithAlphanumeric))), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    // import {Foo, bar, …} from "./baz";
    {match: and(hasOnlyNamedMembers, isRelativeModule, member(startsWithUpperCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
    // import {foo, bar, …} from "./baz";
    {match: and(hasOnlyNamedMembers, isRelativeModule, member(startsWithLowerCase)), sort: moduleName(unicode), sortNamedMembers: name(unicode)},
